...
// MFCApplication6.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMFCApplication6App

CMFCApplication6App theApp;


// Инициализация CMFCApplication6App
